...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__26757){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26758__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__26766_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__26766_SHARP_);
}));
