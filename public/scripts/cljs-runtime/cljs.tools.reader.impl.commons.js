...
var G__26890 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26890;
continue;
} else {
return ch;
...
var vec__26865 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26865,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26881){
...
return (function() { 
var G__26921__delegate = function (rdr,_){
...
var G__26921 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__26923__i = 0, G__26923__a = new Array(arguments.length -  1);
while (G__26923__i < G__26923__a.length) {G__26923__a[G__26923__i] = arguments[G__26923__i + 1]; ++G__26923__i;}
  _ = new cljs.core.IndexedSeq(G__26923__a,0,null);
} 
return G__26921__delegate.call(this,rdr,_);};
G__26921.cljs$lang$maxFixedArity = 1;
G__26921.cljs$lang$applyTo = (function (arglist__26924){
var rdr = cljs.core.first(arglist__26924);
var _ = cljs.core.rest(arglist__26924);
return G__26921__delegate(rdr,_);
});
