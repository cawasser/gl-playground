...
G__26934.cljs$tools$reader$reader_types$IPushbackReader$unread$arity$2(null,ch);
...
return (cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4(G__26930,G__26931,G__26932,G__26933) : cljs.tools.reader.read_tagged.call(null,G__26930,G__26931,G__26932,G__26933));
}
} else {
...
if(("\\" === ch__$1)){
var ch_27726__$2 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_27726__$2 == null)){
...
sb.append(ch_27726__$2);
} else {
}

var G__27727 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch__$1 = G__27727;
continue;
}
}
...
var vec__27013 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27013,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27013,(1),null);
...
var G__27769 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,form);
a = G__27769;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__27023 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__27024 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__27024);

try{return cljs.tools.reader.read_delimited_internal(kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__27023);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27036 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27036,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27036,(1),null);
...
var vec__27055 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27055,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27055,(1),null);
...
var vec__27058 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27058,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27058,(1),null);
...
var vec__27095 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27095,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27095,(1),null);
...
var vec__27098 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27098,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27098,(1),null);
...
var sb = (function (){var G__27113 = (new goog.string.StringBuffer());
G__27113.append(initch);
...
var G__27819 = (function (){var G__27125 = sb;
G__27125.append(ch);

return G__27125;
})();
var G__27820 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__27819;
ch = G__27820;
continue;
}
...
switch (G__27145) {
case "\\":
var G__27840 = (function (){var G__27149 = sb;
G__27149.append(cljs.tools.reader.escape_char(sb,reader));
...
break;
default:
var G__27843 = (function (){var G__27152 = sb;
G__27152.append(ch);

return G__27152;
})();
var G__27844 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__27843;
ch = G__27844;
continue;
...
var vec__27169 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(1),null);
...
var vec__27175 = cljs.tools.reader.starting_line_col_info(rdr);
...
var vec__27263 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27263,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27263,(1),null);
...
var vec__27283 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27283,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27283,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta((cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms)));
if(cljs.core.map_QMARK_(m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata(rdr,m);
...
var vec__27320 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27320,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27320,(1),null);
...
var vec__27323 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27323,(1),null);
...
var G__27334 = rdr;
(cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__27334,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,G__27334,true,null,opts,pending_forms));
...
var _STAR_suppress_read_STAR__orig_val__27354 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27355 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27355);

try{var form = (function (){var G__27356 = rdr;
var G__27357 = false;
var G__27358 = cljs.tools.reader.READ_EOF;
var G__27359 = ")";
var G__27360 = opts;
var G__27361 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__27356,G__27357,G__27358,G__27359,G__27360,G__27361) : cljs.tools.reader.read_STAR_.call(null,G__27356,G__27357,G__27358,G__27359,G__27360,G__27361));
})();
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27354);
}});
...
var feature = (function (){var G__27366 = rdr;
var G__27367 = false;
var G__27368 = cljs.tools.reader.READ_EOF;
var G__27369 = ")";
var G__27370 = opts;
var G__27371 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__27366,G__27367,G__27368,G__27369,G__27370,G__27371) : cljs.tools.reader.read_STAR_.call(null,G__27366,G__27367,G__27368,G__27369,G__27370,G__27371));
})();
...
var G__27372 = (function (){var G__27374 = rdr;
var G__27375 = false;
var G__27376 = cljs.tools.reader.READ_EOF;
var G__27377 = ")";
var G__27378 = opts;
var G__27379 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__27374,G__27375,G__27376,G__27377,G__27378,G__27379) : cljs.tools.reader.read_STAR_.call(null,G__27374,G__27375,G__27376,G__27377,G__27378,G__27379));
})();
cljs.tools.reader.check_eof_error(G__27372,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond(G__27372,rdr,first_line);
...
if(cljs.core.truth_(and__4174__auto__)){
var G__27403 = new cljs.core.Keyword(null,"read-cond","read-cond",1056899244).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__27402 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"preserve","preserve",1276846509),null,new cljs.core.Keyword(null,"allow","allow",-1857325745),null], null), null);
return (fexpr__27402.cljs$core$IFn$_invoke$arity$1 ? fexpr__27402.cljs$core$IFn$_invoke$arity$1(G__27403) : fexpr__27402.call(null,G__27403));
} else {
return and__4174__auto__;
}
})())){
...
var _STAR_suppress_read_STAR__orig_val__27418 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__27419 = (function (){var or__4185__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__27419);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__27418);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character(rdr);
}
...
var arg_env_orig_val__27431 = cljs.tools.reader.arg_env;
var arg_env_temp_val__27432 = cljs.core.sorted_map();
(cljs.tools.reader.arg_env = arg_env_temp_val__27432);

try{var form = (function (){var G__27435 = (function (){var G__27440 = rdr;
cljs.tools.reader.reader_types.unread(G__27440,"(");
...
var G__27437 = null;
var G__27438 = opts;
var G__27439 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__27435,G__27436,G__27437,G__27438,G__27439) : cljs.tools.reader.read_STAR_.call(null,G__27435,G__27436,G__27437,G__27438,G__27439));
})();
...
var G__27960 = (i + (1));
var G__27961 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(args,(function (){var or__4185__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__27431);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",ch)){
return cljs.tools.reader.wrapping_reader(new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null))((function (){var G__27468 = rdr;
G__27468.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var G__27979 = cljs.core.next(s);
var G__27980 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__27979;
key_vals = G__27980;
continue;
} else {
...
return (new cljs.core.List(null,new cljs.core.Symbol("cljs.core","with-meta","cljs.core/with-meta",749126446,null),(new cljs.core.List(null,ret,(new cljs.core.List(null,(function (){var G__27501 = cljs.core.meta(form);
return (cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1 ? cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1(G__27501) : cljs.tools.reader.syntax_quote_STAR_.call(null,G__27501));
...
var gensym_env_orig_val__27533 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__27534 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__27534);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__27533);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(token,":"))?cljs.core.ns_name(cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(token)))?(function (){var G__27540 = token;
var G__27540__$1 = (((G__27540 == null))?null:cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__27540,(1)));
var G__27540__$2 = (((G__27540__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__27540__$1));
var G__27540__$3 = (((G__27540__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__27540__$2));
var G__27540__$4 = (((G__27540__$3 == null))?null:cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__27540__$3));
if((G__27540__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns(G__27540__$4);
}
})():(function (){var G__27543 = token;
var G__27543__$1 = (((G__27543 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__27543));
if((G__27543__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__27543__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__27569 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__27569) : f.call(null,G__27569));
} else {
var temp__5733__auto____$1 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
if(cljs.core.truth_(temp__5733__auto____$1)){
var f = temp__5733__auto____$1;
var G__27571 = tag;
var G__27572 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27656,reader){
var map__27660 = p__27656;
...
var opts = map__27660__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__27660__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
