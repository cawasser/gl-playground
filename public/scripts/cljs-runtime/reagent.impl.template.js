...
var G__26777 = o;
goog.object.set(G__26777,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__26796__i < G__26796__a.length) {G__26796__a[G__26796__i] = arguments[G__26796__i + 0]; ++G__26796__i;}
  args = new cljs.core.IndexedSeq(G__26796__a,0,null);
} 
...
var G__26778 = o;
goog.object.set(G__26778,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26799__i < G__26799__a.length) {G__26799__a[G__26799__i] = arguments[G__26799__i + 0]; ++G__26799__i;}
  args = new cljs.core.IndexedSeq(G__26799__a,0,null);
} 
...
var G__26779 = props;
var G__26779__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26779,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26779);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26779__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4185__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26780 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26780,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26780;
}
})(),id_class);
...
var G__26781 = (cljs.core.count(argv) - first_child);
switch (G__26781) {
case (0):
...
var vec__26782 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26782,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26782,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26782,(2),null);
...
var temp__5739__auto___26818 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___26818 == null)){
} else {
var key_26820 = temp__5739__auto___26818;
(jsprops.key = key_26820);
}
...
var temp__5739__auto___26823 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___26823 == null)){
} else {
var key_26824 = temp__5739__auto___26823;
(jsprops.key = key_26824);
}
...
var temp__5739__auto___26830 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___26830 == null)){
} else {
var key_26831 = temp__5739__auto___26830;
(jsprops.key = key_26831);
}
...
var temp__5739__auto___26838 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26838 == null)){
} else {
var key_26839 = temp__5739__auto___26838;
(jsprops.key = key_26839);
}
...
var temp__5739__auto___26840 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___26840 == null)){
} else {
var key_26845 = temp__5739__auto___26840;
(jsprops.key = key_26845);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26785_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26785_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26786 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26786,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26786,(1),null);
...
break;
default:
var G__26856 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26857 = compiler;
v = G__26856;
compiler = G__26857;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26792 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26792 = (function (opts,id,fn_to_element,meta26793){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26792.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26794,meta26793__$1){
var self__ = this;
var _26794__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26792(self__.opts,self__.id,self__.fn_to_element,meta26793__$1));
}));

(reagent.impl.template.t_reagent$impl$template26792.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26794){
var self__ = this;
var _26794__$1 = this;
return self__.meta26793;
}));

(reagent.impl.template.t_reagent$impl$template26792.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26792.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26792.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26792.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26792.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta26793","meta26793",-892989853,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26792.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26792.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26792");

(reagent.impl.template.t_reagent$impl$template26792.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"reagent.impl.template/t_reagent$impl$template26792");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26792.
 */
reagent.impl.template.__GT_t_reagent$impl$template26792 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26792(opts__$1,id__$1,fn_to_element__$1,meta26793){
return (new reagent.impl.template.t_reagent$impl$template26792(opts__$1,id__$1,fn_to_element__$1,meta26793));
});

}

return (new reagent.impl.template.t_reagent$impl$template26792(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
